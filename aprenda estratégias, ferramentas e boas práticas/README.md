<div align=center>
    <img width="150px" src="../src/img/technical-writing-1.svg" alt="Simbolo da Carreira de Documentação da Alura"/>
</div>
...
### Faça esse curso de Softskills e Carreira e:
- Entenda o que é Technical Writing;
- Compreenda a diferença entre Technical Writing e UX Writing;
- Conheça boas práticas para ajudar na elaboração de documentações;
- Conheça os principais tipos de documentação técnica no contexto de TI;
- Entenda os princípios da arquitetura da informação aplicados a TW;
- Aprenda a desenvolver documentações como: Release notes, Troubleshooting, tutoriais e mais;
- Aprenda a planejar e analisar documentações;
