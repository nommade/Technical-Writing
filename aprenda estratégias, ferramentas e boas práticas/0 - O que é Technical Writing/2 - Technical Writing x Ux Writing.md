...
### Semelhanças
- Textos com foco na usabilidade e experiência;
- Menos é mais: textos mais objetivos e concisos;
- O texto como meio de orientar uma ação.   
...
#### Technical Writing
- Escrita que usa palavras mais técnicas.
- Presença maior nos times de desenvolvimento / TI.
- Formatos de conteúdo: documentação técnica, guias do usuário, tutoriais, etc.
...
Por fim, em relação aos próprios formatos de conteúdo que os Tech Writers escrevem: documentações, tutoriais, guias do usuário e assim por diante.

#### UX Writing
- Escrita mais amigável e conversacional.
- Presença maior nos times de UX e Design.
- Formatos de conteúdo: microtextos, tom de voz, etc.
